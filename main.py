...
filename_cognates = "files/cognates.csv"
filename_forms = "files/forms.csv"

if __name__ == '__main__':
    Reader = Reader()
    kroonen = Reader.read_csv(filename_kroonen)
    cognates, com_cognates = Reader.read_csv_cognates(filename_cognates)
    forms, com_forms = Reader.read_csv_forms(filename_forms)
